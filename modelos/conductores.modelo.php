...
class ModeloConductores
{
    ...
    static public function agregarConductorModelo($tabla, $datos)
    {
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (NOMBRE, APELLIDOS, FECHA_NACIMIENTO, CURP, DIRECCION, NUMERO_LICENCIA, ANTIGUEDAD, ID_ESTATUS_CONDUCTORES, ID_SUCURSALES) VALUES (:NOMBRE, :APELLIDOS, :FECHA_NACIMIENTO, :CURP, :DIRECCION, :NUMERO_LICENCIA, :ANTIGUEDAD, :ID_ESTATUS_CONDUCTORES, :ID_SUCURSALES)");
    ...
    public function actualizarConductorModelo($datosC, $tabladb)
    {
        ...
        ANTIGUEDAD = :ANTIGUEDAD, ID_ESTATUS_CONDUCTORES = :ID_ESTATUS_CONDUCTORES, ID_SUCURSALES = :ID_SUCURSALES WHERE ID_CONDUCTORES = :ID_CONDUCTORES");
