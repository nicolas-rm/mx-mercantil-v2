		...
		if(isset($_POST["nuevoUsuario"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoUsuario"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])){
				...
				$datos = array("id_empleado" => $_POST["nuevoEmpleadoU"],
							   "id_rol" => $_POST["nuevoRolU"],
	...
	static public function ctrEditarUsuario(){
		...
		if(isset($_POST["editarPassword"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["editarPassword"])){
				...
				$datos = array("id_empleado" => $_POST["editarEmpleadoU"],
								"id_rol" => $_POST["editarRolU"],
			...
			if($respuesta != "ok"){
				...
				echo '<script>
					...
					swal({
						...
						type: "error",
						title: "¡La nombre del usuario contiene numeros!",
						showConfirmButton: true,
						confirmButtonText: "Cerrar",
						closeOnConfirm: false
