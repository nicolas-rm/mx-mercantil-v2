    ...
    $.ajax({
        ...
        success: function(respuesta) {
           ...
           textField.Rect = [20, 20, 10, 10];
            ...
            pdf.autoTable(columns, data, { margin: { top: 75 }, didDrawPage: header });
            const pageCount = pdf.internal.getNumberOfPages();
            for (var i = 1; i <= pageCount; i++) {
                // Go to page i
                pdf.setPage(i);
                //Print Page 1 of 4 for example
                pdf.text('Pagina ' + String(i) + ' de ' + String(pageCount), 112 - 10, 300 - 20, null, null, "center");
            };
