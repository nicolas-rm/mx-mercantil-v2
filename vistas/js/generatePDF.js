...
$('body').on('click', '#Generar', function(e) {
    ...
    var nombre = "Conductores - " + fecha.getDate() + "-" + (fecha.getMonth() + 1) + "-" + fecha.getFullYear() + "-" + fecha.getHours() + "" + fecha.getMinutes() + "" + fecha.getSeconds() + ".pdf";
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            var header = function(data) {
                ...
                pdf.text(50, 20, "MERCANTIL DEL CONSTRUCTOR S.A DE C.V");
                pdf.setTextColor(0, 0, 0);
                pdf.setFont('helvetica');
                pdf.setFontType('bold');
                pdf.text(60, 40, 'CONTROL DE SERVICIO VEHICULAR');
                ...
                pdf.addImage(imgData, "JPEG", 10, 15, 40, 30);
                // 
            };
            ...
            //     pdf.text('Page ' + String(i) + ' of ' + String(pageCount), 165 - 10, 220 - 20, null, null, "center");
...
$('body').on('click', '#prueba', function(e) {
    ...
    var header = function(data) {
        ...
        pdf.setFont('helvetica');
        pdf.setFontType('bold');
        pdf.addImage(imgData, "JPEG", 15, 10, 60, 40);
        // pdf.setPage(1)
        pdf.text(100, 40, 'CONTROL DE SERVICIO VEHICULAR');
        // 
    };


    var columns = ["Id", "N", "Apellidos", "Telefono", "Edad"];
    var data = [
    ...
    pdf.autoTable(columns, data, { margin: { top: 80 }, didDrawPage: header });
    const pageCount = pdf.internal.getNumberOfPages();
    for (var i = 1; i <= pageCount; i++) {
        // Go to page i
...
$('body').on('click', '#todospdf', function(e) {
    ...
    var datos = new FormData();
    /* SE GUARDA EL VALOR DE LA VARIABLE Y COMO SERA TRASMITIDA / ENCONTRADA */
    datos.append('PDFJStodo', "PDFJStodo");
...
$('body').on('click', '#total', function(e) {
    ...
    var datos = new FormData();
    /* SE GUARDA EL VALOR DE LA VARIABLE Y COMO SERA TRASMITIDA / ENCONTRADA */
    datos.append('PDFJStotal', "PDFJStotal");
...
$('body').on('click', '#camiones', function(e) {
    ...
    var datos = new FormData();
    /* SE GUARDA EL VALOR DE LA VARIABLE Y COMO SERA TRASMITIDA / ENCONTRADA */
    datos.append('CAMIONESTOTAL', "CAMIONESTOTAL");
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            var nombre = "Reporte Camiones - " + fecha.getDate() + "-" + (fecha.getMonth() + 1) + "-" + fecha.getFullYear() + "-" + fecha.getHours() + "" + fecha.getMinutes() + "" + fecha.getSeconds() + ".pdf";
            var datos = new FormData();
